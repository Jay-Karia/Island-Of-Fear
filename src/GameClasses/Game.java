...
//        System.out.println("\ACT I: THE REQUEST");
...
//                Thread.sleep(2000);
                ...
                GameLogic.genFight(player, enemies[0], potions, selectedPotion);
                break;
            }
            case "r": {
                // Right Turn
                ...
                GameLogic.genFight(player, enemies[1], potions, selectedPotion);
                GameLogic.genFight(player, enemies[0], potions, selectedPotion);
;
            }
...
//                    GameLogic.openMap(1);
//                    GameLogic.getInput("", new String[] {}, new String[] {});
//                    k = -1;
//                }
//                // Buying Ammo
